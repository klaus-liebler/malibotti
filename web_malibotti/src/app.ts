...
export interface IMessageSender {
	...
	subscribe(
		listener: (namespaceId: number, messageId: number, payload: Uint8Array) => void
	): () => void;
}
...
export class Application extends LitElement {
	...
	private readonly messageSender: IMessageSender = {
		...
		subscribe: (listener) => this.usb.addMessageListener(listener),
	};
